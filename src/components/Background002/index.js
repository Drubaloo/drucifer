...
function Model(props) {
    ...
    return (
        <group  {...props} dispose={null} position={[0, 0, -300]}>
            ...
            <mesh castShadow receiveShadow geometry={nodes.pyramidCenterWireframe.geometry} material={materials.purpleToonShader} position={[13.05, 79.69, 81.95,]} />
            <mesh castShadow receiveShadow geometry={nodes.coneCenter.geometry} material={materials.purpleToonShader} position={[17.33, -5.58, 0,]} rotation={[-Math.PI / 2, 0, 0,]} />
            ...
            <group position={[192.16, 103.49, 0,]} rotation={[0, 0, 1.96,]}   >
            ...
            <mesh castShadow receiveShadow geometry={nodes.cuberWireframeLeft.geometry} material={materials.purpleToonShader} position={[-203.78, 93.26, 81.44,]} rotation={[0, 0, 0.38,]} />
            <group position={[226.4, -108.26, 81.44,]}   >
            ...
            <group position={[-156.63, 3.28, 0,]} rotation={[0, 0, 0.16,]}   >
            ...
            <mesh castShadow receiveShadow geometry={nodes.pyramidWireframeRight.geometry} material={materials.pinkToonShader} position={[225.88, -90.51, 81.44,]} />
            <group ref={lowerLeftTriangle} position={[-189.29, -87.81, 5.45,]} rotation={[0, 0, -0.77,]}   >
